  ...
  <section id="writings">
    ...
    <ul className="post-list">
      <li className="post-item">
        ...
        <span>
          <a href="series/building-an-interpreter/parser-part-1-fundamental-parts-of-ast-and-basic-statements.html">
            Building an Interpreter: Parser - Part 1: Fundamental parts of AST
      ...
      <li className="post-item">
        ...
        <span>
          <a href="series/rebuilding-mercaris-search/setup-nextjs-with-typescript-prettier-and-jest.html">
            Rebuilding Mercari&apos;s Search: Setup NextJS with TypeScript,
            Prettier, and Jest
          </a>
        </span>
      </li>
      ...
      <li className="post-item">
        ...
        <span>
          <a href="series/data-structures/index.html">Data Structures Series</a>
        </span>
      </li>
      ...
      <li className="post-item">
        ...
        <span>
          <a href="2020/04/fun-with-dates/index.html"> Fun with Dates </a>
        </span>
      </li>
      <li className="post-item">
        <div className="meta">
      ...
      <li className="post-item">
        ...
        <span>
          <a className="" href="2019/07/thoughts-on-my-productivity/index.html">
      ...
      <li className="post-item">
        ...
        <span>
          ...
          >
            Understanding the basics of Ruby on Rails: SQL Databases and how
            they work
          </a>
        </span>
      </li>
