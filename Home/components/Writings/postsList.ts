...
export const postsList: Post[] = [
  {
    datetime: '2026-06-15',
    link: '/finetuning-foundation-models',
  ...
  {
    datetime: '2025-11-26',
    link: '/mastering-pytorch-from-linear-regression-to-computer-vision',
    title: 'Mastering PyTorch: From Linear Regression to Computer Vision',
  },
  {
    datetime: '2025-11-15',
    link: '/ai-ml-for-biology-and-healthcare-a-learning-path',
  ...
  {
    datetime: '2025-04-05',
    link: '/ml-ai-learning-path',
    title: 'ML/AI & Biomedicine Learning Path',
  },
  {
    datetime: '2025-03-20',
    link: '/building-a-linear-regression-from-scratch-with-python-and-mathematics',
    title:
