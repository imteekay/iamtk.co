...
const coverImage = {
  src: '/series/building-an-interpreter/analysis-2.jpeg',
  width: '592',
  height: '394',
  alt: 'Two men discussing and writing in a whiteboard',
  authorHref: 'https://unsplash.com/@isaacmsmith',
...
export const pageData = {
  ...
  description:
    'The second part of the Lexical Analysis implementation of the interpreter',
  date: '2021-05-29',
  tags,
  coverImage,
};
