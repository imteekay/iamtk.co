...
<img
  src="/the-evolution-of-react-rendering-architectures-and-web-performance-impact/csr.png"
  class="full"
  loading="lazy"
/>
...
The time between the start of JavaScript download to rendering the LCP can be huge, in some cases, it can even reach 16s on mobile 4g. Even if you optimize the application with [code-splitting](https://www.iamtk.co/web-performance-code-splitting-strategies-and-react-applications) and [browser caching](https://www.iamtk.co/webpack-bundle-splitting-and-browser-caching), it's challenging to get better Core Web Vitals (CWV). The problem increases the bigger your final bundle is. The more your application's bundle size increases, the more you hurt the final users’ experience.
...
<img
  src="/the-evolution-of-react-rendering-architectures-and-web-performance-impact/ssr.png"
  class="full"
  loading="lazy"
/>
...
<SideBySideImages
  images={[
    '/the-evolution-of-react-rendering-architectures-and-web-performance-impact/ssr-without-streaming.png',
    '/the-evolution-of-react-rendering-architectures-and-web-performance-impact/ssr-with-streaming.png',
  ]}
/>
...
<img
  src="/the-evolution-of-react-rendering-architectures-and-web-performance-impact/e-commerce.png"
  loading="lazy"
/>
...
<img
  src="/the-evolution-of-react-rendering-architectures-and-web-performance-impact/static-rendered.png"
  loading="lazy"
/>
...
<img
  src="/the-evolution-of-react-rendering-architectures-and-web-performance-impact/static-hydrated.png"
  loading="lazy"
/>
...
<img
  src="/the-evolution-of-react-rendering-architectures-and-web-performance-impact/dynamic-rendered-hydrated.png"
  loading="lazy"
/>
...
- [https://deno.com/blog/the-future-and-past-is-server-side-rendering](https://deno.com/blog/the-future-and-past-is-server-side-rendering)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://medium.com/walmartglobaltech/the-benefits-of-server-side-rendering-over-client-side-rendering-5d07ff2cefe8](https://medium.com/walmartglobaltech/the-benefits-of-server-side-rendering-over-client-side-rendering-5d07ff2cefe8)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://www.debugbear.com/blog/server-side-rendering](https://www.debugbear.com/blog/server-side-rendering)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://shopify.github.io/hydrogen-v1/tutorials/streaming-ssr](https://shopify.github.io/hydrogen-v1/tutorials/streaming-ssr)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://web.dev/rendering-on-the-web](https://web.dev/rendering-on-the-web/)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://www.youtube.com/watch?v=PN1HgvAOmi8](https://www.youtube.com/watch?v=PN1HgvAOmi8&ab_channel=RealWorldReact)&utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://www.youtube.com/watch?v=95B8mnhzoCM](https://www.youtube.com/watch?v=95B8mnhzoCM)&utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://blog.logrocket.com/streaming-ssr-with-react-18](https://blog.logrocket.com/streaming-ssr-with-react-18/)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://beta.nextjs.org/docs/data-fetching/streaming-and-suspense](https://beta.nextjs.org/docs/data-fetching/streaming-and-suspense)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter

### React

- [https://github.com/reactwg/react-18/discussions/37](https://github.com/reactwg/react-18/discussions/37)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://github.com/facebook/react/pull/14717](https://github.com/facebook/react/pull/14717)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://prateeksurana.me/blog/future-of-rendering-in-react](https://prateeksurana.me/blog/future-of-rendering-in-react/)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://beta.reactjs.org/reference/react/Suspense](https://beta.reactjs.org/reference/react/Suspense)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://www.youtube.com/watch?v=h_vVsPwvcsg](https://www.youtube.com/watch?v=h_vVsPwvcsg)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter

### Web Performance

- [https://github.com/imteekay/web-performance-research](https://github.com/imteekay/web-performance-research)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://web.dev/quintoandar/#results](https://web.dev/quintoandar/#results)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
- [https://www.patterns.dev/posts/nextjs-casestudy](https://www.patterns.dev/posts/nextjs-casestudy)?utm_source=[iamtk.co](http://iamtk.co/)&utm_medium=referral&utm_campaign=tk_newsletter
