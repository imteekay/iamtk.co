...
Element render delay drastically improved with all the hydration fixes:
...
The LCP metric went back to the previous state and even improved a bit. We reached LCP below 2s for the search page.
