...
Peaks and valleys. This is how I describe my year in terms of writing. I started strong, writing and publishing every week, mostly about [Frontend Architecture](/series/crafting-frontend/spotify-playlist-frontend-system-architecture). Then I focused on working on [building my compiler](https://github.com/imteekay/crafting-an-interpreter), started a [series about it](/series/building-an-interpreter), got busy, and stopped writing for a while. Did some courses and [implemented a new interpreter](https://github.com/imteekay/essentials-of-interpretation) and [did a series of posts](/series/essentials-of-interpretation) about it and my [learnings working on the mini TypeScript](/tags/programming-language-design).
...
In terms of books, I already mentioned in my [last piece](/bookshelf/2023-booklist) that I would choose books that
