...
Another interesting idea I did was to [build a neural network from scratch](https://www.iamtk.co/building-a-neural-network-from-scratch-with-mathematics-and-python), and calculate all derivatives by hand in the backpropagation step.
