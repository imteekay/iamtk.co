...
For INP, it didn't move the needle that much, only ~15ms improvement for desktop and mobile together. I suspect that it didn't have much effect because of the improvement we had using the [yielding technique](/optimizing-inp-for-a-react-app-and-performance-learnings) that I shared a couple of weeks ago. But I'm still investigating it.
