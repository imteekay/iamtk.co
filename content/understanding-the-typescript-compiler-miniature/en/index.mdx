...
I divided this [series](/series/the-typescript-compiler) into three parts and the following posts to cover everything about the TypeScript compiler. The first two are already published and you can take a look at them here:
