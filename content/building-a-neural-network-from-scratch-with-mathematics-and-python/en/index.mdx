...
<BlockMath>
  `\begin{equation}z = w x + b\end{equation}`
</BlockMath>
...
<BlockMath>
  `\begin{equation}A^{[1]} = g^{[1]}(Z^{[1]})\end{equation}`
</BlockMath>
...
<BlockMath>
  `\begin{equation}f(Z) = max(Z, 0)\end{equation}`
</BlockMath>
...
<InlineMath>`g\'(z^{[1]})`</InlineMath> is the derivative of the loss function with
respect to the activation function <InlineMath>`g`</InlineMath>. In the example
of this post, we need to do the derivative of the ReLU activation function.
...
<BlockMath>
  `\begin{equation}dZ^{[2]} = {A}^{[2]} - Y\end{equation}`
</BlockMath>

<BlockMath>`\begin{equation}dW^{[2]} = \frac{1}{m} \cdot {dZ}^{[2]} \cdot {A^{[1]}}^T\end{equation}`</BlockMath>

<BlockMath>
  `\begin{equation}dB^{[2]} = \frac{1}
  {m} \cdot \sum_{(i = 1)}^m dZ^{[2]}\end{equation}`
</BlockMath>

<BlockMath>`\begin{equation}dZ^{[1]} = {W^{[2]}}^T \cdot {dZ^{[2]}} \cdot g\'(Z^{[1]})\end{equation}`</BlockMath>

<BlockMath>
  `\begin{equation}dW^{[1]} = \frac{1}
  {m} \cdot dZ^{[1]} \cdot X^T\end{equation}`
</BlockMath>

<BlockMath>
  `\begin{equation}dB^{[1]} = \frac{1}
  {m} \cdot \sum_{(i = 1)}^m dZ^{[1]}\end{equation}`
</BlockMath>
...
<BlockMath>
  `\begin{equation}A^{[1]} = ReLU(Z^{[1]})\end{equation}`
</BlockMath>
...
<BlockMath>
  `\begin{equation}A^{[2]} = softmax(Z^{[2]})\end{equation}`
</BlockMath>
...
<InlineMath>`Y`</InlineMath> is the one hot encoding of <InlineMath>
  `Y`
</InlineMath> in this context.
