...
## [Set up routes](https://github.com/leandrotk/prefetch-chunk/pull/1/files)
...
## [Add webpack-bundle-analyzer](https://github.com/leandrotk/prefetch-chunk/pull/2/files)
...
## [Separate pages in loadables](https://github.com/leandrotk/prefetch-chunk/pull/3/files)
...
## [Prefetch next page](https://github.com/leandrotk/prefetch-chunk/pull/4/files)
...
- [Set up routes](https://github.com/leandrotk/prefetch-chunk/pull/1/files): add 4 different pages to use for prefetching purpose
- [Add webpack-bundle-analyzer](https://github.com/leandrotk/prefetch-chunk/pull/2/files): add library to make Webpack bundles easy to analyze
- [Loadables for pages](https://github.com/leandrotk/prefetch-chunk/pull/3/files): code splitting adding loadable for each page
- [Prefetch next page](https://github.com/leandrotk/prefetch-chunk/pull/4/files): using the Webpack prefetch feature to prefetch the next page
...
For more resources on performance, take at my [Web Performance Studies](https://github.com/leandrotk/web-performance-studies). It's a repository with all the resources I've been consuming to learn about performance.
