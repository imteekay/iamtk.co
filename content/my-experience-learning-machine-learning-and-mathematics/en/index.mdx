...
- ML practice: building ML pipelines for [different problems](https://www.iamtk.co/training-ml-models-for-cancer-tumor-classification)
- Deep Learning theory: mathematics and DL concepts
- Deep Learning practice: [building neural nets from scratch](https://www.iamtk.co/building-a-neural-network-from-scratch-with-mathematics-and-python)
...
The second was a classification problem. The idea of the challenge was to [predict whether the breast cancer tumors were malignant or benign](https://github.com/imteekay/breast-cancer-prediction). I've even written a long-format post about the whole process and the learnings along the way: [Training ML Models for Cancer Tumor Classification](https://www.iamtk.co/training-ml-models-for-cancer-tumor-classification).
