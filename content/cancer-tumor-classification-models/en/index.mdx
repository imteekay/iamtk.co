...
Some months ago I've been studying hard the fundamental knowledge of Machine Learning. I started with the [theoretical knowledge of mathematics](/mathematics-for-machine-learning) and machine learning algorithms. While I was studying all that, I also pushed myself to get more practical and try to apply all this knowledge to some data challenges.
...
<img src="/cancer-tumor-classification-models/001.png" loading="lazy" />

<img src="/cancer-tumor-classification-models/002.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/003.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/004.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/005.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/006.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/007.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/008.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/009.png" loading="lazy" />

<img src="/cancer-tumor-classification-models/010.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/011.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/012.png" loading="lazy" />

<img src="/cancer-tumor-classification-models/013.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/014.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/015.png" loading="lazy" />

For recall, the comparison looks similar to the accuracy score. PCA performing way better than the other ones:

<img src="/cancer-tumor-classification-models/016.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/017.png" loading="lazy" />

For recall, it becomes very obvious PCA is performing way better than the other models:

<img src="/cancer-tumor-classification-models/018.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/019.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/020.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/021.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/022.png" loading="lazy" />
...
<img src="/cancer-tumor-classification-models/023.png" loading="lazy" />

<img src="/cancer-tumor-classification-models/024.png" loading="lazy" />
...
As I'm learning more and more about ML and statistics, I'll keep improving this project and this article. I plan to train a deep learning model for this problem and update this article in the future with the results, which will be quite interesting.
