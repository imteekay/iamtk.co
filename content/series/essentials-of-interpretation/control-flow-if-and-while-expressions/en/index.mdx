...
As we learned in the [previous post about global vs local scope and environments](/series/essentials-of-interpretation/variables-environments-and-blocks), we can add all the comparison operators as built-in expressions of the language. That way, we don't actually need to parse and evaluate them.
