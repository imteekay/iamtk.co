...
Designing new frontend architectures is always a challenge and we should take everything in consideration to choose the best trade-offs.

Clarifying question is super important because you need to understand the user/system requirements, what you should focus first and what you can postpone to a "next version".
...
I hope you could learn about some ideas from this post and maybe use them in your next architecture design or even in future interviews.
